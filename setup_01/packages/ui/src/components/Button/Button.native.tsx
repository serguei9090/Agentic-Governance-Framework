...
export interface ButtonProps {
    ...
    size?: 's' | 'm' | 'l';
    label: string;
    onPress?: () => void; // Mapped from onClick in usage if needed, but keeping standard prop names for native usually involves onPress
    isLoading?: boolean;
}
...
export const Button: React.FC<ButtonProps> = ({
    ...
    const getTextStyle = (): TextStyle => {
        const baseStyle: TextStyle = {
            fontFamily: TYPOGRAPHY.fontFamily.sans.split(',')[0], // Take first font family
            fontWeight: '500', // React Native expects string or specific number values
        };
