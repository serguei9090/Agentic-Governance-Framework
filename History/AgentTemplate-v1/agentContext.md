...
### **7. `.agent/rules/errormanagement.md` (Resilience)**
*   **Purpose:** Handling failures gracefully.
*   **Required Content:**
    *   **User Facing:** Show friendly Toasts/Snackbars (never raw stack traces).
    *   **Internal:** Log to a structured logging service (console in dev).
    *   **Sanitization:** NEVER log passwords, keys, or PII.
