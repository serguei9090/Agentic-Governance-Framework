...
*   **Required Content:**
    ...
    *   **Tooling Authority:** Create `ProDoc/tech-stack.md`. You MUST audit the Requirement File.
        *   **MANDATORY:** You MUST initialize the stack with the **Project Defined [LINTER]** and **[TEST_RUNNER]**.
...
*   **Tech Stack Alignment:** Remove any other rule files that do not pertain to the selected tech stack (e.g., remove language specific rules that do not pertain to the stack if they were copied).
